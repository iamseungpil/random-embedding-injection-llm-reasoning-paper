...
This appendix complements Section~\ref{sec:application} with the DAPO loss modifications relative to GRPO, the DAPO~+~RSP implementation, and full per-step results. The training code is included in the same anonymized repository at \url{https://github.com/rsp-anon-2026/RandomSoftPrompt}, and pretrained DAPO and DAPO\,+\,RSP checkpoints across training steps 10--100 are released on Hugging Face at \url{https://huggingface.co/rsp-anonymous-2026/RandomSoftPrompt}, allowing the per-step results in Table~\ref{tab:dapo_per_step} to be reproduced without re-running the training stage.
