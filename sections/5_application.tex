...
\begin{table}[!ht]
\centering
\caption{Per-benchmark accuracy (\%) at each method's peak step on Qwen2.5-Math-7B. \textbf{Bold} denotes the better of the two RL methods on each benchmark. Avg is the unweighted four-benchmark mean.}
\label{tab:dapo_peak}
\footnotesize
