...
RSP's \emph{direct accuracy gains} thus concentrate in misaligned-input recovery and stay within $\pm$a few percentage points on well-aligned instruct models. The effects this paper centers on are the token-, trajectory-, and outcome-level diversity documented in \S\ref{sec:diversity}, with accuracy recovery as a secondary outcome (quantitative analysis and multi-seed evaluation are future work).
